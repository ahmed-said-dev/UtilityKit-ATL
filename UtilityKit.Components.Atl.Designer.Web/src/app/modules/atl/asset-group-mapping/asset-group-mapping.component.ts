...
import { DialogData } from '../shared/commo/confirmation-dialog/confirmation-dialog-model';
...
} from './asset-group-mapping.service';
...
@Component({
  selector: 'app-asset-group-mapping',
  templateUrl: './asset-group-mapping.component.html',
  styleUrls: ['./asset-group-mapping.component.scss'],
})
export class AssetGroupMappingComponent implements OnInit {
  ...
  dataLoading: boolean;
  destinationFields: import('../shared/destinationField').Field[] | undefined;
